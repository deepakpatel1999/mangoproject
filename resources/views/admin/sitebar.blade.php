 <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
     <div class="menu_section">
         ...
         <ul class="nav side-menu">
             ...
             <li><a><i class="fa fa-edit"></i> Inspiration <span class="fa fa-chevron-down"></span></a>
                 <ul class="nav child_menu">

                     <li><a href="{{ route('inspiration') }}">Get Inspiration </a></li>

                 </ul>

             </li>
             <li><a><i class="fa fa-edit"></i> Subcription <span class="fa fa-chevron-down"></span></a>
                 <ul class="nav child_menu">

                     <li><a href="{{ route('user-subcription-list') }}">User Subcription List </a></li>
             ...
             <li><a><i class="fa fa-edit"></i> E-SHOPPER <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                    ...
                    <li><a href="{{ route('setting-display') }}">E-Shoper Banner </a></li>
