...
<div class="right_col" role="main">
    <div class="">
        ...
        <a href="{{ route('banner-create-data') }}" class="btn btn-primary btn-sm"
        ...
        <div class="row" style="display: block;">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="{{ url('banner-data-update') }}" method="POST"
                                    ...
                                    <input type="file" id="" name="banner" value=""
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="{{ url('banner-data-delete') }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
            ...
            <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Banner List Table <small> </small></h2>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($var as $value)
                                        ...
                                        <tr class="even pointer">
                                            ...
                                            <td class=" "><img src="{{ asset('/images/' . @$value->banner) }}"
                                                    alt="image" style="height: 60;width: 60px;"></td>
                                            <td class=" last">
                                                <a class="dropdown-item" data-toggle="modal"
                                                    data-target="#editmodel{{ $value->id }}"><i
                                                        class="fas fa-edit" style="font-size:px;color:blue"></i>
                                                    Edit</a>
