    ...
    <div class="">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Add Most Love BY</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-sm-12 col-md-12 text-center">
                            ...
                            <form method="POST" action="{{ route('add-most-love') }}" class="form-inline"
                                ...
                                <br>
                                <div class="form-group">
                                    <label for="exampleInputName2">Image</label><br>
                                    <input type="file" class="form-control files" id="filse" name="files"
                                        value="{{ old('files') }}" placeholder="Enter Image">
        ...
        <div class="row" style="display: block;">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="{{ url('most-love-update') }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <input type="file" id="" name="files" value=""
                                        ...
                                        <img src="{{ asset('/images/' . @$value->image) }}" alt="image"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="{{ url('most-love-delete') }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
            ...
            <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Most Love List Table <small> </small></h2>
                    ...
                    <div class="x_content">
                        ...
                        <p> Most Love by Table<code></code> </p>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($var as $value)
                                        ...
                                        <tr class="even pointer">
                                            ...
                                            <td class=" "><img src="{{ asset('/images/' . @$value->image) }}" alt="image"
