...
<div class="right_col" role="main">
    <div class="">
        ...
        <a href="{{ route('create-try-somthing') }}" class="btn btn-primary btn-sm"
        ...
        <div class="row" style="display: block;">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="{{ url('try-something-update') }}" method="POST"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="{{ url('try-something-delete') }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
            ...
            <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Try Somthing List Table <small> </small></h2>
                    ...
                    <div class="x_content">
                        ...
                        <p> Try Somthing Table<code></code> </p>
