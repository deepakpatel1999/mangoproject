                                ...
                                <tbody>
                                    ...
                                    @foreach ($subscription as $subscriptions)
                                        ...
                                        <tr class="even pointer">
                                            ...
                                            <td class=" ">{{ @$subscriptions->updated_at }}</td>
                                            <td class=" last">

                                                <a href="{{ route('upgrate', $subscriptions->id) }}"
                                                    class="btn btn-sm"
                                                    onclick="return confirm('Do you really want to Upgrate List?')"><i
                                                        class="fa fa-edit" style="font-size:20px;green:red"></i></a>

                                                <a href="{{ route('canceled', $subscriptions->id) }}"
                                                    class="btn btn-sm"
                                                    onclick="return confirm('Do you really want to Canceled List?')"><i
                                                        class="fa fa-remove" style="font-size:20px;color:red"></i></a>
